...
const mockLabels: Label[] = [
  ...
  },
  {
    ...
    color: '#ccccff',
    description:
      'Одновременное выполенение условий: (1) ИНН плательщика = ИНН должника (2) В назначение платежа входит строка "возм" и/или "расх"',
  },
  {
    id: 3,
    name: 'КоммерсантЪ',
  ...
  },
  {
    ...
    color: '#d2f9ec',
    description:
      'Одновременное выполнение двух условий: (1) ИНН получателя = 7725752265 (2) Вхождение строки "услуг" и/или "доступ" и/или "счет"',
  },
  {
    id: 7,
    name: 'Задатки',
